...
import com.suhas.japi.BusinessManager;
...
public class UsersResources {
	...
	@ApiOperation(value = "Find User", notes = "This Api retrieves the public information for the user(private info is retuened if this is the auth user)"
	...
	public Response getUserById(
		...
		if (userId == null) {
			return Response.status(Response.Status.BAD_REQUEST)
					.entity("{\"error\":\"Not Authorised. Empty userId\", \"status\":\"FAIL\"}").build();
		}
